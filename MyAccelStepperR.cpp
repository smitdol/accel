...
MyAccelStepperR::MyAccelStepperR(const uint8_t interface, const uint8_t digitalPin, bool enable)
...
void MyAccelStepperR::disableOutputs() {
...
void MyAccelStepperR::enableOutputs()
{
  uint8_t oldSREG = SREG;
  cli();
...
void MyAccelStepperR::setOutputPins(uint8_t bits)
{
...
void MyAccelStepperR::step4(long step)
{
...
void MyAccelStepperR::setAcceleration(float acceleration)
{
...
void MyAccelStepperR::setMaxSpeed(float speed)
{
	_cmin = (long)(1000000.0 / speed);
  AccelStepper::setMaxSpeed( speed);
}

unsigned long MyAccelStepperR::computeNewSpeed()
{
