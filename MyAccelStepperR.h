...
#ifndef MyAccelStepperR_h
#define MyAccelStepperR_h
#include "IMyAccelStepper.h"
#include "AccelStepper.h"
class MyAccelStepperR : public AccelStepper, public IMyAccelStepper
{
public:
    virtual ~MyAccelStepperR() = default;
    MyAccelStepperR(const uint8_t interface, const uint8_t digitalPin, bool enable = true);
